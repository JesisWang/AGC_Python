...
if __name__ == '__main__':
    sta_config=pd.read_excel('D:/pyworkspace/Data_Get/assets/sta_cl_ah_config.xlsx')
    index =      [  0,    1,    2,   5,    6,    7,   14,   15,   16,  33,  4]  #调频电站序号
    sta_data_date = '2019-10-17 00:00:00'
    end_data_date = '2019-10-18 00:00:00'
    dianzhan      =        5
    jizu = input('请输入机组：')
    jizu = int(jizu)
    if jizu == 1:
...
#     人工操作
    ...
    index_loc = 'HB'
    a = pd.read_csv(r'E:\1伪D盘\AGC运行\河北宣化电厂储能电站\数据\储能Data2019-10-17-2.csv',index_col = 0,header = 0,encoding='gbk')
    b = pd.read_csv(r'E:\1伪D盘\AGC运行\河北宣化电厂储能电站\数据\AGCData2019-10-17-2.csv',index_col = 0,header = 0,encoding='gbk')
